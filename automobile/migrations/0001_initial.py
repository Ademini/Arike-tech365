    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.CharField(choices=[('BMW', 'BMW'), ('Mercedes', 'Mercedes'), ('Toyota', 'Toyota'), ('Honda', 'Honda')], max_length=50)),
                ('transmission', models.CharField(choices=[('BMW', 'BMW'), ('Mercedes', 'Mercedes'), ('Toyota', 'Toyota'), ('Honda', 'Honda')], max_length=50)),
